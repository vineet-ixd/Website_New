        ...
        <div id="hamburger-content-band">
            <div id="mobile-selector">
                <select id="research-selector" class="mobile-dropdown-nav">
                    ...
                    <option value="hci-for-dev.php" selected>HCI FOR DEVELOPMENT</option>
                    <option value="hci-se.php">SE + HCI</option>
        ...
        <div class="page-content">
            <section>
                ...
                <ul id="research-domain-list">
                    ...
                    <li><a href="hci-for-dev.php" class="link research-domain-list-active">DESIGN FOR DEVELOPMENT</a></li>
                    <li class="center-text"><a href="hci-se.php" class="link">HCI + SE</a></li>
                ...
                <ul class="publication-list">
                    <li class="publication-list-items"><a class="link" target="_blank" href="http://dl.acm.org/citation.cfm?id=3025482">Chameleon Devices: Investigating More Secure and Discreet Mobile Interactions via Active Camouflaging</a>; <a class="link" target="_blank" href="https://chi2017.acm.org/">CHI 2017</a>&nbsp;&nbsp;//&nbsp;&nbsp;
